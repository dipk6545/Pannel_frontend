        ...
        <div className="flex flex-col justify-between p-4 leading-normal">
          ...
          <div className="flex gap-4">
            {["Connect Now", "Learn More"].map((item)=><button key={item}
              type="button"
              className={`text-white ${item==="Connect Now"?"bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
